...
export class Config {
    debugLogging = 'debug';
    'server.port' = '8081';
    'jhipster.clientApp.name' = 'adoptar';
    ...
    'jhipster.mail.from' = 'adoptar@localhost';
    'jhipster.swagger.default-include-pattern' = '/api/.*';
    'jhipster.swagger.title' = 'adoptar API';
    'jhipster.swagger.description' = 'adoptar API documentation';
    ...
    'eureka.instance.appname' = 'adoptar';
    'eureka.instance.instanceId' = 'adoptar:${random.value}';
